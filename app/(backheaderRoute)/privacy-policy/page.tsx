      ...
      <PrivacyPolicyPageContainer>
        ...
        <ContentSection>
          <div className={"terms-container"}>
            <h3 className={"terms-title"}>제1조(목적)</h3>
            <p>
              <strong>Team Exiters</strong>(이하 &apos;회사&apos;라고 함)는
              회사가 제공하고자 하는 서비스(이하 &apos;회사 서비스&apos;)를
              ...
              하기 위하여 다음과 같이 개인정보처리방침(이하 &apos;본
              방침&apos;)을 수립합니다.
            </p>
            <h3 className={"terms-title"}>제2조(개인정보 처리의 원칙)</h3>
            <p>
            ...
            <h3 className={"terms-title"}>제3조(본 방침의 공개)</h3>
            <ol>
              <li>
            ...
            <h3 className={"terms-title"}>제4조(본 방침의 변경)</h3>
            <ol>
              <li>
              ...
              <li>
                ...
                <ol>
                  <li>
                    회사가 운영하는 인터넷 홈페이지의 첫 화면 공지사항란 또는
                    별도의 창을 통하여 공지하는 방법.
                  </li>
                  <li>
            ...
            <h3 className={"terms-title"}>제5조(회원 가입을 위한 정보)</h3>
            <p>
            ...
            <ol>
              <li>
                필수 수집 정보: 이메일 주소, 비밀번호, 이름, 닉네임 및 생년월일
              </li>
              <li>선택 수집 정보: 프로필 이미지</li>
            </ol>
            ...
            <ol>
              <li>필수 수집 정보: 아이디, 이메일 주소, 이름 및 생년월일</li>
            </ol>
            ...
            <ol>
              ...
              <li>
                회사는 오후9시부터 그다음 날 오전 8시까지의 시간에 전자적
            ...
            <ol>
              ...
              <li>
                ...
                포함)ㆍ처리위탁ㆍ보관(이하 &apos;이전&apos;이라 함)하려면
                이용자의 동의를 받습니다. 다만, 본조 제3항 각 호의 사항 모두를
                개인정보보호법 등 관계 법규에 따라 공개하거나 전자우편 등
                대통령령으로 정하는 방법에 따라 이용자에게 알린 경우에는
                개인정보 처리위탁ㆍ보관에 따른 동의절차를 거치지 아니할 수
                있습니다.
              </li>
              <li>
                ...
                <ol>
                  ...
                  <li>
                    개인정보를 이전받는 자의 성명(법인인 경우 그 명칭 및
                    정보관리 책임자의 연락처를 말한다)
                  </li>
                  <li>
                    개인정보를 이전받는 자의 개인정보 이용목적 및 보유ㆍ이용
                    기간
                  </li>
                </ol>
              </li>
                ...
                <ol>
                  <li>
                    ...
                    <ol>
                      <li>성명: 정승민</li>
                      <li>직책: 팀 리더</li>
                      <li>전화번호: 010-9007-9720</li>
                      <li>이메일: seugnmin1266@gmail.com</li>
                    </ol>
                  </li>
                </ol>
              </li>
            ...
            <h3>부칙</h3>
            <p>제1조 본 방침은 2025.02.09.부터 시행됩니다.</p>
          </div>
        </ContentSection>
      </PrivacyPolicyPageContainer>
    </PrivacyPolicyPageWrapper>
